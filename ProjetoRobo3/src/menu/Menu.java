...
public class Menu {
    public Menu() {
        ...
        int contRobo1 = 0;
        int contRobo2 = 0;
        System.out.println("Modos dois robos , um normal e outro inteligente se movendo aleatoriamente");
        System.out.println("Digite a cor do robo normal");
        String cor = input.nextLine();
        Robo robo1 = new Robo(cor);
        System.out.println("Digite a cor do robo inteligente");
